...
//checkUserRole checks given role against the user role extracted from JWT token (in context)
func checkUserRole(requiredRole string, ctx context.Context) error {
	user := &numan.User{}
